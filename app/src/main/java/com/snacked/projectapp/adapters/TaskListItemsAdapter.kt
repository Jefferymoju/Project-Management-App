    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder){
            ...
            holder.itemView.findViewById<ImageButton>(R.id.ib_done_list_name).setOnClickListener{
             val listName = holder.itemView.findViewById<AppCompatEditText>(R.id.et_task_list_name).text.toString()
            ...
            holder.itemView.findViewById<ImageButton>(R.id.ib_edit_list_name).setOnClickListener{
                holder.itemView.findViewById<AppCompatEditText>(R.id.et_edit_task_list_name).setText(model.title)
            ...
            holder.itemView.findViewById<ImageButton>(R.id.ib_done_edit_list_name).setOnClickListener{
                ...
                findViewById<AppCompatEditText>(R.id.et_edit_task_list_name).text.toString()
            ...
            holder.itemView.findViewById<ImageButton>(R.id.ib_done_card_name).setOnClickListener{
                val cardName = holder.itemView.findViewById<AppCompatEditText>(R.id.et_card_name).text.toString()
